...
async function run() {
    try {
        ...
        if ( ! process.env.GITHUB_WORKSPACE ) {
            __webpack_require__(2437).config({path: '.env'});
            folder = "";
        }
